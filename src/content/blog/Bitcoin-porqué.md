...
Por otro lado, quienes se enfocan en la funcionalidad práctica afirman que Bitcoin no es útil como dinero. Señalan que ya existen métodos como Bizum, tarjetas de crédito o transferencias bancarias, y que muy pocas personas utilizan Bitcoin en su día a día para pagar o enviar dinero.

Mi posición es clara: actualmente, Bitcoin no cumple con los requisitos para ser considerado un buen dinero. Sus limitaciones incluyen la velocidad de las transacciones, los elevados costes operativos y la volatilidad de su precio, lo que lo hace poco práctico, especialmente para quienes necesitan liquidez en su día a día o carecen de capacidad de ahorro a largo plazo.
...
El ahorro siempre conlleva renunciar a otras opciones de inversión que podrían haber sido más rentables, dependiendo de las necesidades y el contexto de cada persona. Esta decisión es inherente a cualquier forma de ahorro.

2. Coste de almacenamiento
Todas las formas de ahorro tienen un coste asociado a su mantenimiento:

Acciones: Requieren de un broker, que cobra comisiones anuales por custodia y gestión.
Viviendas: Implican gastos recurrentes como el IBI, reformas, derramas y otros impuestos.
Materias primas (como el oro): Necesitan almacenarse con medidas de seguridad adecuadas, lo que puede ser costoso.
En este ámbito, Bitcoin es claramente ventajoso, ya que no genera costes de mantenimiento físico. No obstante, requiere tiempo y esfuerzo para aprender a gestionarlo de forma segura y evitar pérdidas por errores o ataques.
3. Costes de transacción
Cuando se convierte el ahorro en bienes o servicios, suelen surgir costes adicionales:

Dinero fiat: Tiene costes de transacción muy bajos, especialmente con euros o dólares en operaciones electrónicas.
Viviendas: Los costes asociados son elevados, incluyendo notarios, impuestos y gastos hipotecarios.
Oro: La verificación de la autenticidad puede ser costosa, especialmente para pequeñas cantidades.
Instrumentos financieros: Comisiones similares a las de Bitcoin, aunque no tan bajas como las de las monedas fiat.
Bitcoin, en este caso, presenta un coste medio: no es tan barato como el fiat, pero tampoco tan caro como las viviendas o el oro.

4. Coste de dilución
La dilución, o pérdida de valor relativo por aumento de la oferta, es un factor clave en la comparación:

Bitcoin: Una de sus mayores ventajas radica en la previsibilidad y la limitada emisión. Actualmente, su tasa de inflación es del 0,85% anual, pero caerá al 0,2% en 2033 y prácticamente al 0% en 2050.
Acciones: Pueden diluirse cuando una empresa emite nuevas participaciones, reduciendo el valor relativo de las ya existentes.
Viviendas: Aunque en España actualmente la oferta es limitada en áreas urbanas, en 2008 hubo una sobreoferta que afectó negativamente su valor.
Dinero fiat: Sufre de alta inflación en el largo plazo debido a la constante creación de oferta monetaria.
Oro: A pesar de ser escaso, se sigue extrayendo a una tasa cercana al 2% anual. Aunque esta tasa debería reducirse con el tiempo, el avance tecnológico y un eventual aumento de precio podrían impulsar métodos más eficientes de extracción.
Conclusión
...
Bajos costes acumulativos:
Bitcoin no tiene costes de mantenimiento significativos, como ocurre con otros activos financieros o materiales. A largo plazo, esto resulta clave, ya que los costes recurrentes, aunque parezcan pequeños, se acumulan debido al efecto del interés compuesto, disminuyendo la riqueza real. Con Bitcoin, este impacto se reduce considerablemente.

Resistencia a la dilución:
La emisión limitada de Bitcoin lo protege frente a la inflación. A medida que su tasa de creación anual se reduce y tiende a 0 (en 2050 estará cerca del 0%), la posibilidad de que pierda valor debido a un aumento de la oferta desaparece. Esto permite a los ahorradores preservar su riqueza, siempre y cuando la demanda no disminuya drásticamente. Por el contrario, activos como el dinero fiat, las acciones o incluso el oro, dependen de la entrada constante de nuevos demandantes para mantener su valor real.

Independencia de terceros:
Bitcoin no requiere intermediarios financieros ni instituciones para su almacenamiento o transferencia. Esto elimina comisiones, conflictos de interés y posibles restricciones externas, ofreciendo mayor control a los usuarios sobre sus ahorros.

Inconvenientes y riesgos
A pesar de sus ventajas, Bitcoin enfrenta varios inconvenientes y riesgos:

Volatilidad del precio:
Aunque Bitcoin es el séptimo activo más valioso del mundo por capitalización de mercado, su demanda no está completamente estabilizada. Muchas personas compran Bitcoin como una inversión especulativa, lo que genera movimientos bruscos de precio. Esto lo convierte en un instrumento poco adecuado para quienes necesitan liquidez inmediata o tienen compromisos financieros a corto plazo. En países pobres, aunque podría ser una solución teórica, su adopción es limitada porque la mayoría de las personas viven al día y no pueden ahorrar.

Falta de registros históricos:
Bitcoin tiene apenas 15 años de existencia, lo que dificulta prever su comportamiento a largo plazo. A diferencia del oro, que tiene un historial de miles de años, no sabemos cómo se comportará ante crisis económicas o cómo evolucionarán las regulaciones fiscales y legales en los diferentes países.

Riesgos tecnológicos y de seguridad:
Aunque Bitcoin es uno de los sistemas más seguros en internet, no está exento de riesgos:

Ataques a la descentralización: Un ataque coordinado a los nodos o a la red podría afectar su funcionamiento.
Dependencia del sistema de incentivos: La seguridad de Bitcoin depende de los mineros, cuya participación está directamente ligada al precio del activo. Si el precio bajara de forma significativa, algunos mineros abandonarían la red, reduciendo la dificultad del minado y debilitando la seguridad. Esto podría generar una "espiral bajista", en la que la inseguridad desincentive aún más a los usuarios, causando una caída adicional en el precio. En casos extremos, una baja dificultad permitiría a un actor con recursos suficientes controlar la red y secuestrarla, destruyendo la confianza en Bitcoin y su utilidad como reserva de valor.
Incógnitas regulatorias:
Los gobiernos aún están definiendo cómo regular Bitcoin. Cambios en la legislación fiscal o restricciones de uso podrían limitar su adopción, lo que afectaría directamente su demanda y, por ende, su precio.
